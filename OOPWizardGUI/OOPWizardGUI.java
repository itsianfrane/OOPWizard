...
class QuizApp {
    ...
    private void addQuestions() {
        ...
        questions.add(new Question("What is the correct syntax for printing \"Hello, World!\" to the console in Java?", "C",
                new String[]{"A. Console.WriteLine(\"Hello, World!\");", "B. print(\"Hello, World!\");",
                        "C. System.out.println(\"Hello, World!\");", "D. echo \"Hello, World!\";"}));
        questions.add(new Question("Which of the following is an example of inheritance in OOP?", "A",
                new String[]{"A. A child class inheriting from a parent class", "B. A class implementing an interface",
                        "C. A class containing methods", "D. A class with a constructor"}));
        questions.add(new Question("Which of the following is an example of polymorphism?", "B",
                new String[]{"A. Using different classes for different tasks",
                        "B. A method having the same name but different behavior in different classes",
                        "C. Using different data types", "D. Inheritance"}));
        questions.add(new Question("What is encapsulation in OOP?", "C",
                new String[]{"A. Accessing data directly", "B. Inheriting methods",
                        "C. Hiding internal details and showing only necessary parts", "D. Polymorphism"}));
        questions.add(new Question("Which of the following is a private method?", "A",
                new String[]{"A. A method that cannot be accessed outside its class", "B. A method that is shared between classes",
                        "C. A method that only returns values", "D. A method with no parameters"}));
        ...
        questions.add(new Question("What is the purpose of the main method in a Java program?", "C",
                new String[]{"A. It's the last method to be executed.", "B. It's used for defining classes.",
                        "C. It's the entry point of the program, where execution begins.", "D. It's used for input and output operations."}));
        ...
        questions.add(new Question("What is the purpose of a method's return type?", "A",
                new String[]{"A. It defines what type of value the method will return", "B. It specifies the method's parameters",
                        "C. It defines the method's name", "D. It determines the method's access level"}));
        questions.add(new Question("Which of these is an abstract method?", "B",
                new String[]{"A. A method that has no body and must be implemented by subclasses", "B. A method that contains a return statement",
                        "C. A method that is static", "D. A method that uses inheritance"}));
    ...
    public void startQuiz() {
        ...
        questionLabel.setFont(new Font("Comic Sans MS", Font.PLAIN, 18)); // Handwriting font
    ...
    private void displayQuestion(JLabel questionLabel, JPanel answerPanel, JFrame quizFrame) {
        ...
        if (currentQuestionIndex < questions.size()) {
            ...
            Color[] buttonColors = {new Color(173, 216, 230), // Light Blue
            ...
            for (String choice : currentQuestion.getChoices()) {
                ...
                choiceButton.setBackground(buttonColors[colorIndex]);
